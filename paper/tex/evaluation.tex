...
In comparing the scalar implementation, the \VERB{Opt.} implementation gains a reduced instruction count to 0.63\% of the OpenSSL baseline instruction count.
