...
For comparing the scalar implementation, the \VERB{Opt.} implementation gains a reduced instruction count (about $0.63\times$) compared to the OpenSSL baseline.
...
The instruction count of the $V_4$ implementation is reduced to about $0.29\times$ (resp. $0.18\times$) of the instruction count of the \VERB{Opt.} (resp. the baseline) implementation.
