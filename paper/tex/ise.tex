...
To support ChaCha ISE, The Rocket Chip core has an additional configuration to support custom instructions, for which we choose the \VERB[asm]{Custom 0} opcode \cite[Chapter 25]{RV:ISA:I}, to decode the ChaCha ISE.
