...
%  uint32\xspace $a1,a0, b1, b0, r1, r0$; \;
  ...
  $r1 \ASN (a1 \XOR b1)\LRT Dec[\VERB[ASM]{imm}];$ \; 
  $r0 \ASN (a0 \XOR b0)\LRT Dec[\VERB[ASM]{imm}];$ \;
  $\GPR[*][{\VERB[ASM]{rd}}] \ASN (r1 \LSH 32) \IOR r0;$ \;
}
...
Furthermore, in Xor-then-Rotation instruction, the rotate amount \VERB[ASM]{imm} is encoded using only 2 instruction bits that is decoded in hardware.
