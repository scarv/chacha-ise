...
\INST{chacha20.v2.ad0    rd, rs1, rs2}{
...
\INST{chacha20.v2.bc0    rd, rs1, rs2}{
...
\INST{chacha20.v2.ad1    rd, rs1, rs2}{
  uint32\xspace $a,b,c,d na,nd$; \;
  $a \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; d \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
  $b \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; c \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
  $na \ASN a + b;$ \$
...
\INST{chacha20.v2.bc1    rd, rs1, rs2}{
  uint32\xspace $a,b,c,d, na,nd$; \;
  $a \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; d \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
  $b \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; c \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
  $nc \ASN c + d;$ \;
...
The first two ISEs (i.e. \VERB[ASM]{chacha20.v2.ad0} and \VERB[ASM]{chacha20.v2.bc0}) are used to compute the top half of the quarter round while the other two ISEs computer the bottom halve.
...
\begin{algorithm}
	...
	\BlankLine
	\KwFn{$\ALG{QuarterRound}( X, Y )$}{
		\VERB[ASM]{chacha20.v2.ad0} X', X, Y \;
		\VERB[ASM]{chacha20.v2.bc0} Y', X, Y \;
		\VERB[ASM]{chacha20.v2.ad1} R0, X', Y' \;
		\VERB[ASM]{chacha20.v2.bc1} R1, X', Y' \;
		$\KwRet{\TUPLE{ R0, R1 }}$ \;
	}
...
\INST{chacha20.v3.add   rd, rs1, rs2}{
...
\INST{chacha20.v3.xorrol  rd, rs1, rs2, imm}{
  uint32\xspace $a1,a0, b1, b0, r1, r0$; \;
  const $Dec = \{ 16, 12, 8, 7 \}$
  $a1 \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; a0 \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
  $b1 \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; b0 \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
...
%\INST{chacha20.v3.xorrol.16  rd, rs1, rs2}{
%	uint32\xspace $a1,a0, b1, b0, r1, r0$; \;
%	$a1 \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; a0 \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
%	$b1 \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; b0 \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
...
%\INST{chacha20.v3.xorrol.12  rd, rs1, rs2}{
%  uint32\xspace $a1,a0, b1, b0, r1, r0$; \;
%  $a1 \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; a0 \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
%  $b1 \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; b0 \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
...
%\INST{chacha20.v3.xorrol.8  rd, rs1, rs2}{
%  uint32\xspace $a1,a0, b1, b0, r1, r0$; \;
%  $a1 \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; a0 \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
%  $b1 \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; b0 \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
...
%\INST{chacha20.v3.xorrol.7  rd, rs1, rs2}{
%  uint32\xspace $a1,a0, b1, b0, r1, r0$; \;
%  $a1 \ASN \GPR[*][{\VERB[ASM]{rs1}}] \RSH 32; a0 \ASN \GPR[*][{\VERB[ASM]{rs1}}];$ \;
%  $b1 \ASN \GPR[*][{\VERB[ASM]{rs2}}] \RSH 32; b0 \ASN \GPR[*][{\VERB[ASM]{rs2}}];$ \;
...
\KwFn{$\ALG{HalfRound}( X, Y, Z, W )$}{
  \VERB[ASM]{chacha20.v3.add}     X', X,  Y     \;
  \VERB[ASM]{chacha20.v3.xorrol}  W', W,  X', 0 \;
  \VERB[ASM]{chacha20.v3.add}     Z', Z,  W'    \;
  \VERB[ASM]{chacha20.v3.xorrol}  Y', Y,  Z', 1 \;
  \VERB[ASM]{chacha20.v3.add}     R0, X', Y'    \;
  \VERB[ASM]{chacha20.v3.xorrol}  R3, W', R0, 2 \;
  \VERB[ASM]{chacha20.v3.add}     R2, Z', R3    \;
  \VERB[ASM]{chacha20.v3.xorrol}  R1, Y', R2, 3 \;
